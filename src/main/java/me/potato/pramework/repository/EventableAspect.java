...
import me.potato.pramework.dtos.EventableEntity;
...
public class EventableAspect {
  ...
  @After(value = "execution(* me.potato.pramework.repository.EventableRepository.save(..))")
  ...
  @After(value = "execution(* me.potato.pramework.repository.EventableRepository.deleteById(..))")
  ...
  @After(value = "execution(* me.potato.pramework.repository.EventableRepository.delete(..))")
